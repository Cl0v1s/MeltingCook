...
var riot = require('riot');
module.exports = riot.tag2('app-useredit', '<app-header></app-header> <app-usereditform ref="form" user="{{}}" callback="{send}"></app-usereditform> <app-footer></app-footer>', '', '', function(opts) {
        var tag = this;
